...
const data: DeckData = {
  title: "Portal HQ × Uniquely You! — Partnership Conversation",
...
.s4-context-card h3 { font-size: 1rem; color: var(--dark); margin-bottom: 8px; }
.s4-context-card p { font-size: 0.9rem; color: var(--body); line-height: 1.6; }
...
<section class="slide slide--dark" id="cover" data-slide-index="0" data-theme="dark">
  <div class="orb" style="width:500px;height:500px;top:-150px;right:-100px;background:var(--teal);opacity:0.08;animation:floatDrift 12s ease-in-out infinite;"></div>
  <div class="orb" style="width:350px;height:350px;bottom:-100px;left:-80px;background:var(--coral);opacity:0.06;animation:floatDrift 15s ease-in-out infinite 3s;"></div>
  ...
  <div class="slide-inner">
    ...
    <h1 class="cover-title">
      <span class="line-1" data-reveal="up" data-delay="200">Jake</span>
      <span class="line-2" data-reveal="up" data-delay="300">Berlin</span>
    ...
    <p class="cover-subtitle">
      <span class="text-reveal-mask">
        <span class="text-reveal-inner">Downtown Raleigh's coworking hub meets the community that needs accessible gathering space the most &mdash; and almost never gets it.</span>
      </span>
    </p>
    ...
    <div class="cover-footer" data-reveal="fade" data-delay="1100">
      <span>Prepared for Jake Berlin, Portal HQ &nbsp;|&nbsp; April 2026</span>
...
<!-- SLIDE 2: THE GAP — WHY THIS MATTERS -->
<section class="slide slide--cream" id="why" data-slide-index="1" data-theme="light">
  <div class="slide-inner">
    <div class="section-eyebrow" data-reveal="up" data-delay="0">The Gap Downtown</div>
    <h2 class="section-title" data-reveal="up" data-delay="100" style="text-align:center;margin-left:auto;margin-right:auto;">Disability-friendly event space is shockingly rare</h2>
    <p class="section-subtitle" data-reveal="up" data-delay="200" style="text-align:center;margin-left:auto;margin-right:auto;">Downtown Raleigh is booming, but one community keeps getting left out of the room.</p>

    <div class="s2-quote" data-reveal="scale" data-delay="300">
      "There are dozens of event venues downtown. But when families in the disability community look for a space that's truly accessible &mdash; ADA-compliant, sensory-friendly, welcoming by design &mdash; <span class="s2-quote-em">the list shrinks to almost nothing.</span>"
    </div>
    <p class="s2-author" data-reveal="fade" data-delay="500">-- On the accessibility gap in downtown Raleigh</p>
    ...
    <div class="s2-timeline" id="s2Timeline">
      <div class="s2-tl-item" data-reveal="up" data-delay="600">
        ...
        <div class="s2-tl-title">1 in 4 adults</div>
        <div class="s2-tl-desc">Live with a disability in the U.S. That's roughly 61 million people &mdash; and their families, caregivers, and allies make up a massive community with few gathering options.</div>
      </div>
      ...
      <div class="s2-tl-item" data-reveal="up" data-delay="800">
        ...
        <div class="s2-tl-title">Not enough venues</div>
        <div class="s2-tl-desc">Most downtown spaces check the legal ADA box but aren't designed with disability in mind &mdash; no sensory considerations, no flexible layouts, no real welcome.</div>
      </div>
      ...
      <div class="s2-tl-item" data-reveal="up" data-delay="1000">
        ...
        <div class="s2-tl-title">Portal HQ can change that</div>
        <div class="s2-tl-desc">A modern, flexible coworking and event space in the heart of downtown &mdash; already built for community. Partnering with UY! puts you at the center of an audience that's been underserved for years.</div>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="slide-inner">
    ...
    <div class="s3-pillars">
      <div class="s3-pillar s3-pillar--coral" data-reveal="up" data-delay="700">
        ...
        <p>Every issue features real people in the Triangle living boldly with disability &mdash; profiles that celebrate their stories and strengthen community.</p>
      </div>
      <div class="s3-pillar s3-pillar--teal" data-reveal="up" data-delay="850">
        ...
        <h3>Resource Hub</h3>
        <p>Local events, service directories, support groups, and community calendars &mdash; connecting readers to what they need.</p>
      </div>
      <div class="s3-pillar s3-pillar--gold" data-reveal="up" data-delay="1000">
        ...
        <p>Policy updates, accessibility news, employer spotlights &mdash; content that moves the needle on inclusion in RDU.</p>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="slide-inner">
    ...
    <div class="s4-chart" id="s4Chart">
      ...
      <div class="s4-bar-col" data-reveal="up" data-delay="600">
        ...
        <div class="s4-bar-label">N2GIVES &mdash; donated to fight human trafficking</div>
      </div>
    ...
    <div class="s4-context">
      ...
      <div class="s4-context-card s4-context-card--aside" data-reveal="right" data-delay="1000">
        <h3>Why a coworking space fits</h3>
        <p>People with disabilities are underrepresented in professional networking, entrepreneurship, and community events. A venue partner that actively welcomes this audience signals something most spaces never bother to say: <em>you belong here.</em></p>
      </div>
      <div class="s4-context-card s4-context-card--aside" data-reveal="up" data-delay="1100" style="grid-column:1/-1;">
        <h3>Audience overlap</h3>
        <p>Families, caregivers, advocates, nonprofits, and service providers already in UY!'s monthly readership are exactly who would attend events, workshops, and mixers at Portal HQ &mdash; if they knew the space existed and welcomed them.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="slide slide--cream" id="partnership" data-slide-index="4" data-theme="light">
  <div class="slide-inner">
    ...
    <p class="section-subtitle" data-reveal="up" data-delay="200">Three tiers of engagement &mdash; each one reinforces the next.</p>
    ...
    <div class="s7-staircase">
      <div class="s7-step s7-step--1" data-reveal="up" data-delay="400">
        ...
        <h3>Be Present</h3>
        <p>Consistent, beautifully designed ad in every issue of Uniquely You!</p>
        <ul class="s7-step-items">
          <li>Print ad &mdash; we design it for you</li>
      ...
      <div class="s7-step s7-step--2" data-reveal="up" data-delay="600">
        ...
        <h3>Host Events</h3>
        <p>Position Portal HQ as downtown Raleigh's go-to accessible event venue for the disability community.</p>
        <ul class="s7-step-items">
          <li>Quarterly UY! community mixers at Portal HQ</li>
          <li>Workshop &amp; resource fair co-hosting</li>
          <li>Event coverage in the magazine</li>
        </ul>
      </div>
      ...
      <div class="s7-step s7-step--3" data-reveal="up" data-delay="800">
        ...
        <h3>Be Remembered</h3>
        <p>Feature stories on Portal HQ's accessibility commitment, Jake's vision for inclusive coworking, and the events making a difference &mdash; the kind of content people keep.</p>
        <ul class="s7-step-items">
      ...
      <div class="tier-panel tier-panel--premium" id="tier1">
        ...
        <div class="tier-cards">
          <div class="tier-card">
            ...
            <div class="tier-card-desc">Maximum impact &mdash; grab attention with large images</div>
          ...
          <div class="tier-card">
            ...
            <div class="tier-card-desc">Most prominent real estate &mdash; first thing seen at the mailbox</div>
            <span class="tier-term-badge">36 months</span>
          </div>
        </div>
      ...
      <div class="tier-panel tier-panel--fullpage" id="tier2">
        ...
        <div class="tier-cards">
          ...
          <div class="tier-card">
            ...
            <div class="tier-card-desc">Full-page body ad &mdash; maximum impact</div>
            <span class="tier-term-badge">36 months</span>
          </div>
        </div>
        <a class="tier-skip" href="#start">Ready? Let's go &rarr;</a>
