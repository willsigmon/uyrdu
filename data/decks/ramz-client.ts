...
const data: DeckData = {
  title: "Ram-Z Services × Uniquely You! — Partnership Overview",
  ...
  <div class="slide-inner">
    ...
    <p class="cover-subtitle">
      <span class="text-reveal-mask">
        <span class="text-reveal-inner">A community-first publication connecting families, caregivers, and local businesses across the Triangle &mdash; and the partner opportunity behind it.</span>
      </span>
    </p>
...
<section class="slide slide--cream" id="why" data-slide-index="1" data-theme="light">
  <div class="slide-inner">
    ...
    <h2 class="section-title" data-reveal="up" data-delay="100" style="text-align:center;margin-left:auto;margin-right:auto;">A community that&rsquo;s underserved and growing</h2>
    <p class="section-subtitle" data-reveal="up" data-delay="200" style="text-align:center;margin-left:auto;margin-right:auto;">Families navigating disability in the Triangle don&rsquo;t have a single trusted resource. That&rsquo;s what we&rsquo;re building.</p>
    ...
    <div class="s2-timeline" id="s2Timeline">
      <div class="s2-tl-item" data-reveal="up" data-delay="600">
        ...
        <div class="s2-tl-desc">1 in 4 U.S. adults has a disability. In the Triangle alone, that&rsquo;s hundreds of thousands of people &mdash; plus their families, caregivers, and support networks.</div>
      </div>
      ...
      <div class="s2-tl-item" data-reveal="up" data-delay="800">
        ...
        <div class="s2-tl-desc">No other publication serves this community in the RDU metro. Uniquely You! is the first and only &mdash; early partners get first-mover advantage.</div>
      </div>
      ...
      <div class="s2-tl-item" data-reveal="up" data-delay="1000">
        ...
        <div class="s2-tl-desc">Part of N2&rsquo;s 36-market national network with 800+ publications, $163M in reach, and 20+ years of proven infrastructure behind every issue.</div>
      </div>
    </div>
  </div>
</section>
...
<section class="slide slide--cream" id="synergy" data-slide-index="3" data-theme="light">
  ...
  <div class="slide-inner">
    ...
    <p class="section-subtitle" data-reveal="up" data-delay="200" style="text-align:center;margin-left:auto;margin-right:auto;">More than an ad &mdash; a relationship with a loyal, engaged, and growing community.</p>
    ...
    <div class="s4-grid">
      <div class="s4-card s4-card--coral" data-reveal="up" data-delay="350">
        ...
        <p>Your ad appears in a high-quality magazine mailed directly to homes &mdash; plus a digital companion with clickable links. We handle all the design.</p>
      </div>
      ...
      <div class="s4-card s4-card--gold" data-reveal="up" data-delay="550">
        ...
        <p>Partners can be featured in spotlight articles &mdash; your story, your mission, your expertise shared with thousands of readers who value purpose-driven businesses.</p>
      </div>
      ...
      <div class="s4-card s4-card--purple" data-reveal="up" data-delay="650">
        ...
        <p>Every partner is listed in our online resource directory at uyrdu.com &mdash; a permanent, searchable presence connecting you to families actively looking for support.</p>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="slide-inner">
    ...
    <div class="s7-staircase">
      <div class="s7-step s7-step--1" data-reveal="up" data-delay="400">
        ...
        <h3>Be Present</h3>
        <p>A beautifully designed ad in every issue &mdash; we handle the creative. Your brand in front of families and business owners every month.</p>
      ...
      <div class="s7-step s7-step--2" data-reveal="up" data-delay="600">
        ...
        <h3>Be Useful</h3>
        <p>Value-first content that positions you as a go-to resource. Contributed tips, expert insights, or seasonal spotlights &mdash; we help you create it.</p>
        <ul class="s7-step-items">
      ...
      <div class="s7-step s7-step--3" data-reveal="up" data-delay="800">
        ...
        <h3>Be Remembered</h3>
        <p>Feature stories that share your mission, your background, and your why &mdash; the kind of content people keep and pass along.</p>
        <ul class="s7-step-items">
...
<section class="slide slide--cream" id="pricing" data-slide-index="5" data-theme="light">
  ...
  <div class="slide-inner" style="justify-content:center;">
    ...
    <h2 class="section-title" data-reveal="up" data-delay="100" style="max-width:none;">36-Month Partnership Options</h2>
    <p style="text-align:center;font-size:0.82rem;color:#999;margin-top:4px;" data-reveal="up" data-delay="140">Billed monthly. No upfront lump sum. Full-page placements and above.</p>

    <div class="pricing-runway" data-reveal="up" data-delay="200" style="gap:24px;">
      <div class="tier-panel tier-panel--premium tier-visible" style="flex:1;max-width:100%;opacity:1;padding:28px;">
        ...
        <div class="tier-cards">
          <div class="tier-card">
            ...
            <div class="tier-card-desc">Maximum impact &mdash; the biggest canvas in the magazine</div>
          ...
          <div class="tier-card">
            ...
            <div class="tier-card-desc">First thing seen at the mailbox &mdash; prime real estate</div>
            <span class="tier-term-badge">36 months</span>
          </div>
        </div>
      </div>
      <div class="tier-panel tier-panel--fullpage tier-visible" style="flex:1;max-width:100%;opacity:1;padding:28px;">
        ...
        <div class="tier-cards">
          <div class="tier-card">
            ...
            <div class="tier-card-desc">Premium full-page position near the front</div>
            <span class="tier-term-badge">36 months</span>
          </div>
          <div class="tier-card">
            <div class="tier-card-name">Full Page Standard</div>
            <div class="tier-card-price">$575<span>/mo</span></div>
            <div class="tier-card-desc">Full-page ad anywhere in the body</div>
            <span class="tier-term-badge">36 months</span>
          </div>
        </div>
      </div>
    ...
    <table class="rate-table" data-reveal="up" data-delay="350" style="margin-top:24px;">
      <thead>
        <tr>
          <th>Ad Size</th>
          <th>Monthly Rate</th>
      ...
      <tbody>
        <tr><td>2-Page Spread</td><td><strong>$795</strong>/mo</td></tr>
        <tr><td>Back Cover</td><td><strong>$765</strong>/mo</td></tr>
        <tr><td>Inside Cover / Pg 2-3</td><td><strong>$675</strong>/mo</td></tr>
        <tr><td>Full Page Standard</td><td><strong>$575</strong>/mo</td></tr>
      </tbody>
    </table>
  </div>
</section>
...
<section class="slide slide--dark" id="start" data-slide-index="6" data-theme="dark">
  ...
  <div class="slide-inner" style="display:flex;flex-direction:column;justify-content:center;">
    ...
    <div class="s10-contact" data-reveal="fade" data-delay="380" style="text-align:center;font-size:1rem;color:rgba(255,247,241,0.7);margin-top:24px;">Questions? Reach out anytime.<br><span style="color:#fff;font-weight:600;">Will Sigmon</span> &middot; Area Director &middot; will.sigmon@n2co.com</div>
  </div>
