...
const data: DeckData = {
  title: "Alyssa Malgrat × Uniquely You! — Partnership Conversation",
  navClass: "dot-nav on-dark",
  navItems: [
    { href: "#cover", label: "Cover" },
    { href: "#why", label: "Why ABA" },
...
<section class="slide slide--dark" id="cover" data-slide-index="0" data-theme="dark">
  ...
  <div class="slide-inner">
    ...
    <h1 class="cover-title">
      <span class="line-1" data-reveal="up" data-delay="200">Alyssa</span>
      <span class="line-2" data-reveal="up" data-delay="300">Malgrat</span>
    ...
    <p class="cover-subtitle">
      <span class="text-reveal-mask">
        <span class="text-reveal-inner">Exploring how ABA therapy providers and a hyperlocal disability community magazine can help families find the right support sooner.</span>
      </span>
    </p>
    ...
    <div class="cover-footer" data-reveal="fade" data-delay="1100">
      <span>Prepared for Alyssa Malgrat &nbsp;|&nbsp; March 2026</span>
...
<!-- ============================================================
     SLIDE 2: WHY ABA PROVIDERS
     ============================================================ -->
<section class="slide slide--cream" id="why" data-slide-index="1" data-theme="light">
  <div class="slide-inner">
    <div class="section-eyebrow" data-reveal="up" data-delay="0">Why ABA Therapy</div>
    <h2 class="section-title" data-reveal="up" data-delay="100" style="text-align:center;margin-left:auto;margin-right:auto;">Families need to find you before they need you</h2>
    <p class="section-subtitle" data-reveal="up" data-delay="200" style="text-align:center;margin-left:auto;margin-right:auto;">ABA is one of the most searched, least understood services in the disability space.</p>

    <div class="s2-quote" data-reveal="scale" data-delay="300">
      "Most families don't start looking for ABA until after a diagnosis — and by then, they're overwhelmed. <span class="s2-quote-em">The providers who are already visible and trusted are the ones who get the call.</span>"
    </div>
    ...
    <div class="s2-timeline" id="s2Timeline">
      <div class="s2-tl-item" data-reveal="up" data-delay="600">
        ...
        <div class="s2-tl-title">High-value, high-need</div>
        <div class="s2-tl-desc">ABA therapy is a Tier 1 advertiser category — frequently searched by families, often misunderstood, and underserved in traditional local media.</div>
      </div>
      ...
      <div class="s2-tl-item" data-reveal="up" data-delay="800">
        ...
        <div class="s2-tl-title">Right families, right counties</div>
        <div class="s2-tl-desc">10,000+ households across Wake, Durham, Orange, Johnston, and Chatham counties — families already navigating disability services, therapies, and school systems.</div>
      </div>
      ...
      <div class="s2-tl-item" data-reveal="up" data-delay="1000">
        ...
        <div class="s2-tl-title">Repetition builds trust</div>
        <div class="s2-tl-desc">When a provider shows up month after month in a publication families already read and trust, the referral call feels like a warm introduction — not a cold search.</div>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="slide-inner">
    ...
    <div class="s4-context">
      ...
      <div class="s4-context-card s4-context-card--aside" data-reveal="right" data-delay="1000">
        <h3>Why ABA providers fit</h3>
        <p>Families searching for ABA therapy are already in this readership. They're navigating IEPs, evaluations, and waitlists. A trusted, recurring presence in the magazine they already read makes ABA providers easier to find and easier to trust.</p>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="slide-inner">
    ...
    <div class="s7-staircase">
      ...
      <div class="s7-step s7-step--2" data-reveal="up" data-delay="600">
        ...
        <h3>Be Useful</h3>
        <p>Value-first content positioning ABA providers as a trusted community resource.</p>
        <ul class="s7-step-items">
          <li>ABA myth-busting explainers</li>
          <li>Parent guides to evaluations &amp; intake</li>
          <li>Seasonal tips for school transitions</li>
        </ul>
      </div>
      ...
      <div class="s7-step s7-step--3" data-reveal="up" data-delay="800">
        ...
        <h3>Be Remembered</h3>
        <p>Feature stories that help families understand what ABA actually looks like — the kind of content people keep and share.</p>
        <ul class="s7-step-items">
