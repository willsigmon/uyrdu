...
.sw-house-icon { width: 22px; height: 22px; flex-shrink: 0; }
...
.s4-context-card--quote {
  ...
  border-left: 4px solid var(--purple-sec);
}
...
.s7-price-tag svg { width: 22px; height: 22px; }
.s7-price-text { font-size: 0.92rem; color: var(--body); line-height: 1.5; }
...
/* ================================================================
   SLIDE 9 — PRICING (FULL RATE CARD)
   ================================================================ */
.pricing-intro {
  text-align: center;
  max-width: 920px;
...
<section class="slide slide--dark" id="cover" data-slide-index="0" data-theme="dark">
  ...
  <img class="cover-illustration" src="https://cdni.iconscout.com/illustration/free/preview/free-b2b-corporate-business-partnership-and-professional-network-illustration-svg-download-png-13926035.png" alt="" aria-hidden="true" loading="lazy"/>
  ...
  <div class="slide-inner">
    ...
    <div class="cover-logos" data-reveal="up" data-delay="100">
      ...
      <span class="sw-logotype">
        <svg class="sw-house-icon" viewBox="0 0 24 24" fill="none" stroke="rgba(18,214,160,0.8)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <h1 class="cover-title">
      <span class="line-1" data-reveal="up" data-delay="200">Shelley</span>
      <span class="line-2" data-reveal="up" data-delay="300">Welch</span>
    ...
    <p class="cover-subtitle">
      <span class="text-reveal-mask">
        <span class="text-reveal-inner">A personal, mission-aligned partnership connecting Triangle families to accessible, life-stage-right real estate.</span>
      </span>
    </p>
    ...
    <div class="cover-footer" data-reveal="fade" data-delay="1100">
      <span>Prepared for Shelley Welch, Next Stage Realty &nbsp;|&nbsp; March 2026</span>
...
<section class="slide slide--cream" id="why" data-slide-index="1" data-theme="light">
  <div class="slide-inner">
    <div class="section-eyebrow" data-reveal="up" data-delay="0">Why Shelley Welch</div>
    ...
    <div class="s2-quote" data-reveal="scale" data-delay="300">
      "Shelley didn't just choose real estate -- she trained in Therapeutic Recreation at UNC before making the move. That means the way she thinks about home <span class="s2-quote-em">starts with how people actually live in it.</span>"
    </div>
    <p class="s2-author" data-reveal="fade" data-delay="500">-- On the Shelley Welch &amp; Next Stage Realty approach</p>
    ...
    <div class="s2-timeline" id="s2Timeline">
      <div class="s2-tl-item" data-reveal="up" data-delay="600">
        ...
        <div class="s2-tl-title">Therapeutic roots</div>
        <div class="s2-tl-desc">A UNC degree in Recreation Administration with a Therapeutic Recreation focus. Not many realtors understand adaptive living from the ground up like this.</div>
      </div>
      ...
      <div class="s2-tl-item" data-reveal="up" data-delay="800">
        ...
        <div class="s2-tl-title">Life transitions expert</div>
        <div class="s2-tl-desc">SRES-certified, specializing in seniors relocating, multi-generational living, and families navigating major changes like death, divorce, or downsizing.</div>
      </div>
      ...
      <div class="s2-tl-item" data-reveal="up" data-delay="1000">
        ...
        <div class="s2-tl-title">Community embedded</div>
        <div class="s2-tl-desc">25+ years in the Triangle, Wake Forest Chamber member, and known as the local expert for families finding the right home at the right stage of life.</div>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="slide-inner">
    ...
    <div class="s4-context">
      ...
      <div class="s4-context-card s4-context-card--aside" data-reveal="right" data-delay="1000">
        <h3>Why real estate fits</h3>
        <p>Housing is the #1 practical concern for families navigating disability. Accessible homes, aging-in-place modifications, and multi-generational floor plans are the kind of content readers actively seek.</p>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="slide-inner">
    ...
    <div class="s7-staircase">
      ...
      <div class="s7-step s7-step--2" data-reveal="up" data-delay="600">
        ...
        <h3>Be Useful</h3>
        <p>Value-first content positioning Shelley as a go-to resource for accessible housing.</p>
        <ul class="s7-step-items">
          <li>Sponsored "Home Access" column</li>
          <li>Seasonal housing tips &amp; checklists</li>
          <li>Open house or event highlights</li>
        </ul>
      </div>
      ...
      <div class="s7-step s7-step--3" data-reveal="up" data-delay="800">
        ...
        <div class="s7-step-icon" style="background:rgba(255,199,45,0.1);">
          <svg viewBox="0 0 24 24" fill="none" stroke="var(--gold)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <path d="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3-1.07-2.14-1.5-3.5-1-6 2.5 1 4.5 3.5 4.5 7a4.5 4.5 0 0 1-4.5 4.5c-.28 0-.5.22-.5.5v2h4v2H7v-2c0-1.5.44-2 1.5-2.5z"/>
          </svg>
        </div>
        <h3>Be Remembered</h3>
        <p>Feature stories sharing your origin, your Therapeutic Rec roots, and impact -- the kind of content people keep.</p>
        <ul class="s7-step-items">
...
<!-- ============================================================
     SLIDE 9: PRICING — FULL RATE CARD BREAKDOWN
     ============================================================ -->
      ...
      <table class="rate-table">
        <thead>
          <tr>
            ...
            <th class="popular-col" style="border-radius:0 16px 0 0;">
...
<section class="slide slide--dark" id="start" data-slide-index="6" data-theme="dark">
  ...
  <div class="slide-inner" style="display:flex;flex-direction:column;justify-content:center;">
    ...
    <div class="s10-cta-wrap" data-reveal="scale" data-delay="380" style="margin-top:20px;">
      <a class="s10-cta" href="https://portal.n2pub.com/credit_card_capture" target="_blank" rel="noopener">Let's go</a>
      <div class="s10-cta-sub">Opens the partner portal</div>
    </div>
    <div class="s10-contact" data-reveal="fade" data-delay="440">Will Sigmon · Area Director · will.sigmon@n2co.com</div>
  </div>
