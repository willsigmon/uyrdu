...
const data: DeckData = {
  title: "Landy Townsend × Uniquely You! — Community Partnership",
...
<section class="slide slide--dark" id="cover" data-slide-index="0" data-theme="dark">
  ...
  <div class="slide-inner">
    ...
    <h1 class="cover-title">
      <span class="line-1" data-reveal="up" data-delay="200">Landy</span>
      <span class="line-2" data-reveal="up" data-delay="300">Townsend</span>
    ...
    <p class="cover-subtitle">
      <span class="text-reveal-mask"><span class="text-reveal-inner">You already show up for families with special needs in real life &mdash; through local advocacy, Miracle League leadership, and the patient-centered work of Valeris. UY! is a natural extension of that presence.</span></span>
    </p>
    <div class="cover-pillars" data-reveal="up" data-delay="900">
      <div class="cover-pillar"><div class="cover-pillar-icon cover-pillar-icon--teal"><svg viewBox="0 0 24 24" fill="none" stroke="var(--teal)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M2 12h20"/></svg></div><span class="cover-pillar-label cover-pillar-label--teal">Advocate</span></div>
      <div class="cover-pillar"><div class="cover-pillar-icon cover-pillar-icon--sage"><svg viewBox="0 0 24 24" fill="none" stroke="var(--sage)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg></div><span class="cover-pillar-label cover-pillar-label--sage">Connect</span></div>
      <div class="cover-pillar"><div class="cover-pillar-icon cover-pillar-icon--gold"><svg viewBox="0 0 24 24" fill="none" stroke="var(--gold)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2l2.39 7.36H22l-6.19 4.5L18.2 21 12 16.5 5.8 21l2.39-7.14L2 9.36h7.61z"/></svg></div><span class="cover-pillar-label cover-pillar-label--gold">Amplify</span></div>
    </div>
    <div class="cover-footer" data-reveal="fade" data-delay="1100">
      <span>Prepared for Landy Townsend &middot; VP, Marketing &amp; Communications, Valeris &nbsp;|&nbsp; April 2026</span>
...
<section class="slide slide--ivory" id="why" data-slide-index="1" data-theme="light">
  <div class="slide-inner">
    ...
    <h2 class="section-title" data-reveal="up" data-delay="100" style="text-align:center;margin-left:auto;margin-right:auto;">This already overlaps with the work you care about</h2>
    <p class="section-subtitle" data-reveal="up" data-delay="200" style="text-align:center;margin-left:auto;margin-right:auto;">This isn&rsquo;t a cold corporate fit. Landy already sits close to this community &mdash; personally, locally, and professionally.</p>
    <div class="s2-quote" data-reveal="scale" data-delay="300">&ldquo;The strongest partnerships start when the <span class="s2-quote-em">values are already there</span>.&rdquo;</div>
    ...
    <div class="s2-timeline" id="s2Timeline">
      <div class="s2-tl-item" data-reveal="up" data-delay="600">
        ...
        <div class="s2-tl-title">Personal fit</div>
        <div class="s2-tl-desc">Board Chair of Miracle League of the Triangle, coach since 2014, and a longtime advocate for children with special needs. The community overlap is real before the meeting even starts.</div>
      </div>
      <div class="s2-tl-item" data-reveal="up" data-delay="800">
        ...
        <div class="s2-tl-title">Professional fit</div>
        <div class="s2-tl-desc">As VP, Marketing &amp; Communications at Valeris, Landy already helps shape how a patient-centered company shows up in the world. UY! gives that presence a local, human context.</div>
      </div>
      <div class="s2-tl-item" data-reveal="up" data-delay="1000">
        ...
        <div class="s2-tl-title">Local fit</div>
        <div class="s2-tl-desc">Wake Forest family, Morrisville headquarters, and a readership spread across Wake, Durham, Orange, Johnston, and Chatham. This lands in the same Triangle community Landy already serves.</div>
      </div>
    </div>
  </div>
</section>
...
<section class="slide slide--ivory" id="what" data-slide-index="2" data-theme="light">
  <div class="slide-inner">
    ...
    <h2 class="section-title" data-reveal="up" data-delay="100">A platform built for community-first storytelling</h2>
    <p class="section-subtitle" data-reveal="up" data-delay="200">Uniquely You! is the Triangle&rsquo;s only publication dedicated to the disability community &mdash; the right context for advocacy, local credibility, and stories that feel human instead of promotional.</p>
...
<section class="slide slide--ivory" id="synergy" data-slide-index="3" data-theme="light">
  ...
  <div class="slide-inner">
    ...
    <p class="section-subtitle" data-reveal="up" data-delay="200" style="text-align:center;margin-left:auto;margin-right:auto;">More than an ad &mdash; a standing presence among readers who can tell the difference between performative marketing and people who actually show up.</p>
    <div class="s4-grid">
      <div class="s4-card s4-card--teal" data-reveal="up" data-delay="350"><div class="s4-card-icon" style="background:rgba(46,139,139,0.12);"><svg viewBox="0 0 24 24" fill="none" stroke="var(--teal)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 22h16a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v16a2 2 0 0 1-2 2Zm0 0a2 2 0 0 1-2-2v-9c0-1.1.9-2 2-2h2"/><path d="M18 14h-8"/><path d="M15 18h-5"/><path d="M10 6h8v4h-8V6Z"/></svg></div><h3>Print + Digital Every Month</h3><p>A steady, polished presence in a high-quality magazine mailed to homes &mdash; plus a digital companion with clickable links to community, careers, contact, or impact pages. We handle the design.</p></div>
      <div class="s4-card s4-card--sage" data-reveal="up" data-delay="450"><div class="s4-card-icon" style="background:rgba(135,168,138,0.16);"><svg viewBox="0 0 24 24" fill="none" stroke="var(--sage)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg></div><h3>Values Alignment</h3><p>Caregivers, advocates, parents, therapists, and nonprofit leaders already live in the same world Landy shows up for through Miracle League and local special-needs advocacy.</p></div>
      <div class="s4-card s4-card--gold" data-reveal="up" data-delay="550"><div class="s4-card-icon" style="background:rgba(201,169,97,0.16);"><svg viewBox="0 0 24 24" fill="none" stroke="var(--gold)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2L14.5 9.5L22 12L14.5 14.5L12 22L9.5 14.5L2 12L9.5 9.5L12 2Z"/></svg></div><h3>Feature Story Opportunities</h3><p>Landy&rsquo;s Miracle League connection, family advocacy, and the patient-first side of Valeris can be shared in a way that feels human, local, and credible.</p></div>
      <div class="s4-card s4-card--copper" data-reveal="up" data-delay="650"><div class="s4-card-icon" style="background:rgba(184,115,51,0.12);"><svg viewBox="0 0 24 24" fill="none" stroke="var(--copper)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polygon points="16.24 7.76 14.12 14.12 7.76 16.24 9.88 9.88 16.24 7.76"/></svg></div><h3>Community Directory</h3><p>A permanent, searchable presence in our online directory at uyrdu.com &mdash; so when readers ask who actually shows up for this community, Landy / Valeris are already part of the answer.</p></div>
    </div>
  </div>
</section>
...
<section class="slide slide--ivory" id="partnership" data-slide-index="4" data-theme="light">
  <div class="slide-inner">
    ...
    <p class="section-subtitle" data-reveal="up" data-delay="200">Visibility, trust, and durable community credibility &mdash; matched to the way Landy already shows up in this space.</p>
    <div class="s7-staircase">
      <div class="s7-step s7-step--1" data-reveal="up" data-delay="400"><div class="s7-level-label">Visibility</div><div class="s7-step-icon" style="background:rgba(46,139,139,0.12);"><svg viewBox="0 0 24 24" fill="none" stroke="var(--teal)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 22h16a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v16a2 2 0 0 1-2 2Zm0 0a2 2 0 0 1-2-2v-9c0-1.1.9-2 2-2h2"/><path d="M18 14h-8"/><path d="M15 18h-5"/><path d="M10 6h8v4h-8V6Z"/></svg></div><h3>Be Present</h3><p>A beautifully designed ad in every issue &mdash; we handle the creative so it reads as thoughtful presence, not interruption. Landy / Valeris stay in front of Triangle readers every month.</p><ul class="s7-step-items"><li>Print ad &mdash; we design it for you</li><li>Digital companion with clickable community / careers / contact link</li><li>Logo in partner directory</li></ul></div>
      <div class="s7-step s7-step--2" data-reveal="up" data-delay="600"><div class="s7-level-label">Trust</div><div class="s7-step-icon" style="background:rgba(135,168,138,0.16);"><svg viewBox="0 0 24 24" fill="none" stroke="var(--sage)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg></div><h3>Be Helpful</h3><p>A sponsored community-impact or reader-helpful content series if that feels right &mdash; built around support, advocacy, accessibility, or the patient journey in plain language.</p><ul class="s7-step-items"><li>Recurring expert / impact column</li><li>Community, caregiver, and access explainers</li><li>Seasonal wellness and nonprofit features</li></ul></div>
      <div class="s7-step s7-step--3" data-reveal="up" data-delay="800"><div class="s7-level-label">Legacy</div><div class="s7-step-icon" style="background:rgba(201,169,97,0.16);"><svg viewBox="0 0 24 24" fill="none" stroke="var(--gold)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3q1 4 4 6.5t3 5.5a1 1 0 0 1-14 0 5 5 0 0 1 1-3 1 1 0 0 0 5 0c0-2-1.5-3-1.5-5q0-2 2.5-4"/></svg></div><h3>Be Remembered</h3><p>Long-form features that tell the why behind the partnership &mdash; Miracle League, local advocacy, volunteer work, and the patient-centered culture behind Valeris.</p><ul class="s7-step-items"><li>Two feature profiles per year</li><li>Social media amplification</li><li>Community event co-branding</li></ul></div>
    </div>
  </div>
</section>
...
<section class="slide slide--dark" id="start" data-slide-index="6" data-theme="dark">
  ...
  <div class="slide-inner" style="display:flex;flex-direction:column;justify-content:center;">
    ...
    <h2 class="s8-title" data-reveal="up" data-delay="100" style="margin-bottom:8px;">Let&rsquo;s put your story in front of the readers already in your orbit</h2>
    ...
    <div class="s10-grid" data-reveal="up" data-delay="260">
      <div class="s10-card"><div class="s10-card-label">Ready to move forward</div><ul class="s10-list"><li class="s10-item"><span class="s10-num">1</span><span>Choose the right size and term</span></li><li class="s10-item"><span class="s10-num">2</span><span>Pull in whoever else needs a voice internally</span></li><li class="s10-item"><span class="s10-num">3</span><span>Lock the launch issue and story angle</span></li><li class="s10-item"><span class="s10-num">4</span><span>Creative kickoff &mdash; we design everything for you</span></li></ul></div>
