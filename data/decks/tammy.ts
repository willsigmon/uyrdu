...
const data: DeckData = {
  title: "Tammy Ayers × Uniquely You! — Community Partnership",
  navClass: "dot-nav on-dark",
  navItems: [
    { href: "#cover", label: "Cover" },
    { href: "#why", label: "Why Tammy" },
...
/* SLIDE 4 — RESOURCES */
.s4-hub { display: grid; grid-template-columns: 1fr 1fr; gap: 28px; margin-bottom: 20px; }
.s4-hub-card { background: #fff; border-radius: 16px; padding: 28px; box-shadow: 0 2px 12px rgba(0,0,0,0.04); position: relative; overflow: hidden; }
.s4-hub-card::before { content: ''; position: absolute; top: 0; left: 0; right: 0; height: 4px; }
.s4-hub-card--coral::before { background: linear-gradient(90deg, var(--coral), var(--gold)); }
.s4-hub-card--teal::before { background: linear-gradient(90deg, var(--teal), var(--blue)); }
.s4-hub-card--gold::before { background: linear-gradient(90deg, var(--gold), var(--coral)); }
.s4-hub-card--purple::before { background: linear-gradient(90deg, var(--purple-sec), var(--blue)); }
.s4-hub-icon { width: 48px; height: 48px; border-radius: 14px; display: flex; align-items: center; justify-content: center; margin-bottom: 14px; }
...
@media (max-width: 900px) {
  ...
  .s10-grid, .s4-hub { grid-template-columns: 1fr; }
...
<section class="slide slide--dark" id="cover" data-slide-index="0" data-theme="dark">
  ...
  <div class="slide-inner">
    ...
    <h1 class="cover-title">
      <span class="line-1" data-reveal="up" data-delay="200">Tammy</span>
      <span class="line-2" data-reveal="up" data-delay="300">Ayers</span>
    ...
    <p class="cover-subtitle">
      <span class="text-reveal-mask">
        <span class="text-reveal-inner">A passionate disability advocate and community connector — meeting a publication built to amplify exactly the stories and resources she fights for every day.</span>
      </span>
    </p>
    ...
    <div class="cover-pillars" data-reveal="up" data-delay="900">
      <div class="cover-pillar">
        ...
        <span class="cover-pillar-label cover-pillar-label--coral">Advocate</span>
      </div>
      <div class="cover-pillar">
    ...
    <div class="cover-footer" data-reveal="fade" data-delay="1100">
      <span>Prepared for Tammy Ayers &nbsp;|&nbsp; April 2026</span>
...
<section class="slide slide--cream" id="why" data-slide-index="1" data-theme="light">
  <div class="slide-inner">
    ...
    <div class="s2-quote" data-reveal="scale" data-delay="300">
      "Tammy doesn't just talk about advocacy — she shows up at school board meetings, organizes community events, and <span class="s2-quote-em">fights for the kids and families who need a voice the most.</span>"
    </div>
    <p class="s2-author" data-reveal="fade" data-delay="500">-- On what makes this partnership different</p>
    ...
    <div class="s2-timeline" id="s2Timeline">
      <div class="s2-tl-item" data-reveal="up" data-delay="600">
        ...
        <div class="s2-tl-title">Personal mission</div>
        <div class="s2-tl-desc">A parent who has lived the journey — navigating the system, fighting for the right support, and learning what families actually need.</div>
      </div>
      ...
      <div class="s2-tl-item" data-reveal="up" data-delay="800">
        ...
        <div class="s2-tl-title">School board advocate</div>
        <div class="s2-tl-desc">Attends board meetings and speaks up for families who can't. Her advocacy has already created real pushback against harmful policy changes.</div>
      </div>
      ...
      <div class="s2-tl-item" data-reveal="up" data-delay="1000">
        ...
        <div class="s2-tl-title">Community connector</div>
        <div class="s2-tl-desc">Organizes special needs events, fosters rescue dogs, and knows people across the community — the kind of person who makes introductions happen.</div>
      </div>
    </div>
  </div>
</section>
...
<section class="slide slide--cream" id="resources" data-slide-index="3" data-theme="light">
  ...
  <div class="slide-inner">
    ...
    <div style="text-align:center;margin-bottom:24px;" data-reveal="scale" data-delay="280">
      <span class="s4-url-badge">
    ...
    <div class="s4-hub">
      <div class="s4-hub-card s4-hub-card--coral" data-reveal="up" data-delay="350">
        <div class="s4-hub-icon" style="background:rgba(255,107,107,0.1);">
          <svg viewBox="0 0 24 24" fill="none" stroke="var(--coral)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <p>Every issue is available digitally — share a link instead of hunting down a copy. Families, therapists, and teachers can read it anywhere.</p>
      </div>

      <div class="s4-hub-card s4-hub-card--teal" data-reveal="up" data-delay="450">
        <div class="s4-hub-icon" style="background:rgba(18,214,160,0.1);">
          <svg viewBox="0 0 24 24" fill="none" stroke="var(--teal)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <h3>Nominate a Story</h3>
        <p>Know a family, advocate, or organization doing great work? Submit their name in 30 seconds. We handle the interview and the writing.</p>
      </div>

      <div class="s4-hub-card s4-hub-card--gold" data-reveal="up" data-delay="550">
        <div class="s4-hub-icon" style="background:rgba(255,199,45,0.1);">
          <svg viewBox="0 0 24 24" fill="none" stroke="var(--gold)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <circle cx="12" cy="12" r="10"/>
            <polygon points="16.24 7.76 14.12 14.12 7.76 16.24 9.88 9.88 16.24 7.76"/>
          </svg>
        ...
        <p>Local services, support groups, therapy providers, and community events — all searchable and always up to date. The page families bookmark.</p>
      </div>

      <div class="s4-hub-card s4-hub-card--purple" data-reveal="up" data-delay="650">
        <div class="s4-hub-icon" style="background:rgba(110,38,142,0.1);">
        ...
        <p>Community events, support group meetings, workshops — one place to find and share what's happening. No more scattered Facebook posts.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="slide slide--cream" id="partnership" data-slide-index="4" data-theme="light">
  <div class="slide-inner">
    ...
    <h2 class="section-title" data-reveal="up" data-delay="100">How we work together</h2>
    <p class="section-subtitle" data-reveal="up" data-delay="200">Your advocacy amplified — three ways to make an even bigger impact.</p>

    <div class="s7-staircase">
      <div class="s7-step s7-step--1" data-reveal="up" data-delay="400">
        <div class="s7-level-label">Stories</div>
        <div class="s7-step-icon" style="background:rgba(255,107,107,0.1);">
          <svg viewBox="0 0 24 24" fill="none" stroke="var(--coral)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <path d="M12 2L14.5 9.5L22 12L14.5 14.5L12 22L9.5 14.5L2 12L9.5 9.5L12 2Z"/>
          </svg>
        </div>
        <h3>Share the Voices</h3>
        <p>You know families who deserve to be heard — like yours. We give them a platform, professionally written and beautifully produced.</p>
        <ul class="s7-step-items">
          <li>Nominate families and advocates</li>
          <li>We write the feature story</li>
          <li>Print + digital distribution</li>
        </ul>
      </div>

      <div class="s7-step s7-step--2" data-reveal="up" data-delay="600">
        <div class="s7-level-label">Connections</div>
        ...
        <p>You know the businesses, therapists, and organizations serving this community. We help them reach the families who need them.</p>
        <ul class="s7-step-items">
          <li>Introduce local businesses to UY</li>
          <li>Connect service providers to families</li>
          <li>Grow the resource directory together</li>
        </ul>
      </div>

      <div class="s7-step s7-step--3" data-reveal="up" data-delay="800">
        <div class="s7-level-label">Advocacy</div>
        <div class="s7-step-icon" style="background:rgba(255,199,45,0.1);">
          <svg viewBox="0 0 24 24" fill="none" stroke="var(--gold)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>
          </svg>
        </div>
        <h3>Amplify the Cause</h3>
        <p>School board meetings, policy changes, community wins — your advocacy work gets a bigger megaphone through print and digital reach.</p>
        <ul class="s7-step-items">
          <li>Advocacy updates in every issue</li>
          <li>Community event co-promotion</li>
          <li>A publication that backs you up</li>
        </ul>
      </div>
    </div>
  </div>
