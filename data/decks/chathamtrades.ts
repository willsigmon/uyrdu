...
const data: DeckData = {
  title: "Shawn Poe × Uniquely You! — Strategic Partnership",
...
<section class="slide slide--dark" id="cover" data-slide-index="0" data-theme="dark">
  ...
  <div class="slide-inner">
    ...
    <h1 class="cover-title">
      <span class="line-1" data-reveal="up" data-delay="200">Shawn</span>
      <span class="line-2" data-reveal="up" data-delay="300">Poe</span>
    ...
    <div class="cover-footer" data-reveal="fade" data-delay="1100">
      <span>Prepared for Shawn Poe, Chatham Trades &nbsp;|&nbsp; April 2026</span>
...
`,
  ...
  (function() {
    ...
    function reveal() {
      ...
      if (idx < labels.length) newBtn.innerHTML = labels[idx] + ' &rarr;';
