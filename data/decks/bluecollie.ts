...
const data: DeckData = {
  title: "Blue Collie Coffee × Uniquely You! — Strategic Partnership",
...
.rainbow-bar {
  ...
  background: linear-gradient(90deg, #2A9D8F, #D4952B, #E85D3A, #5B8C6F, #2A9D8F, #D4952B, #E85D3A, #5B8C6F);
...
.dot-nav a {
  width: 10px; height: 10px; border-radius: 50%; border: 2px solid rgba(60, 30, 8, 0.3);
...
.slide--dark { background: linear-gradient(135deg, #1a0a02 0%, var(--dark) 40%, #5A2D0C 100%); color: #fff; }
...
.cover-gradient-strip {
  ...
  background: linear-gradient(90deg, #2A9D8F, #D4952B, #E85D3A, #5B8C6F, #2A9D8F);
...
.uy-mark {
  ...
  letter-spacing: 0.02em; line-height: 1; box-shadow: 0 4px 20px rgba(232,93,58,0.35); position: relative;
}
...
.partner-logotype { font-family: var(--sans); font-size: 1.2rem; font-weight: 600; color: rgba(255,248,240,0.85); letter-spacing: 0.06em; text-transform: uppercase; display: flex; align-items: center; gap: 8px; }
...
.cover-title .line-1 { display: block; color: rgba(255,248,240,0.6); }
...
.cover-title .line-cross { display: block; font-family: var(--sans); font-weight: 300; font-size: clamp(1rem, 2vw, 1.6rem); color: rgba(255,248,240,0.4); letter-spacing: 0.3em; text-transform: uppercase; margin: 8px 0; }
...
.cover-subtitle { font-size: clamp(1rem, 1.8vw, 1.2rem); color: rgba(255,248,240,0.7); max-width: 600px; line-height: 1.7; font-weight: 400; margin-bottom: 20px; }
...
.cover-pillar-icon--coral { background: rgba(232,93,58,0.15); }
.cover-pillar-icon--teal { background: rgba(42,157,143,0.15); }
.cover-pillar-icon--gold { background: rgba(212,149,43,0.15); }
...
.cover-footer { display: flex; justify-content: space-between; color: rgba(255,248,240,0.4); font-size: 0.85rem; font-weight: 400; padding-top: 20px; border-top: 1px solid rgba(255,255,255,0.06); }
...
.section-eyebrow { font-size: 0.8rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.12em; color: var(--brown-sec); }
...
.s2-quote::before {
  content: ''; display: block; width: 48px; height: 36px; margin: 0 auto 10px; background: var(--brown-sec); opacity: 0.12;
...
.s2-quote-em { color: var(--brown-sec); font-style: italic; font-family: var(--sans); font-weight: 500; }
.s2-author { text-align: center; font-weight: 600; color: var(--brown-sec); font-size: 0.95rem; margin-bottom: 16px; }
...
.s2-tl-dot--coral { background: #fff; border: 2px solid rgba(232,93,58,0.3); }
.s2-tl-dot--teal { background: #fff; border: 2px solid rgba(42,157,143,0.3); }
.s2-tl-dot--gold { background: #fff; border: 2px solid rgba(212,149,43,0.3); }
...
.s4-card--teal::before { background: linear-gradient(90deg, var(--teal), var(--sage)); }
.s4-card--gold::before { background: linear-gradient(90deg, var(--gold), var(--coral)); }
.s4-card--brown::before { background: linear-gradient(90deg, var(--brown-sec), var(--sage)); }
...
.s7-level-label { font-size: 0.7rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.12em; color: var(--brown-sec); margin-bottom: 14px; }
...
.tier-panel--entry { background: linear-gradient(135deg, #e8f4f2, #d1f0eb); color: var(--body); border: 1px solid rgba(42,157,143,0.2); }
.tier-label { font-family: var(--display); font-size: 0.75rem; text-transform: uppercase; letter-spacing: 0.12em; margin-bottom: 4px; }
.tier-panel--premium .tier-label { color: rgba(255,248,240,0.5); }
.tier-panel--fullpage .tier-label { color: var(--brown-sec); }
.tier-panel--standard .tier-label { color: var(--sage); }
...
.tier-panel--fullpage .tier-card-price { color: var(--brown-sec); }
.tier-panel--standard .tier-card-price { color: var(--sage); }
...
.tier-panel--premium .tier-card-desc { color: rgba(255,248,240,0.6); }
...
.tier-panel--premium .tier-term-badge { background: rgba(212,149,43,0.15); color: var(--gold); }
.tier-panel--fullpage .tier-term-badge { background: rgba(139,94,60,0.08); color: var(--brown-sec); }
.tier-panel--standard .tier-term-badge { background: rgba(91,140,111,0.1); color: var(--sage); }
.tier-panel--entry .tier-term-badge { background: rgba(42,157,143,0.1); color: var(--teal); }
.tier-skip {
...
.tier-panel--premium .tier-skip { color: var(--gold); background: rgba(212,149,43,0.12); }
.tier-panel--premium .tier-skip:hover { background: rgba(212,149,43,0.22); transform: translateY(-2px); }
.tier-panel--fullpage .tier-skip { color: var(--brown-sec); background: rgba(139,94,60,0.08); }
.tier-panel--fullpage .tier-skip:hover { background: rgba(139,94,60,0.14); transform: translateY(-2px); }
.tier-panel--standard .tier-skip { color: var(--sage); background: rgba(91,140,111,0.1); }
...
.rate-table .popular-col { background: rgba(212,149,43,0.06); }
...
.s8-rainbow { position: absolute; bottom: 0; left: 0; width: 100%; height: 4px; background: linear-gradient(90deg, #2A9D8F, #D4952B, #E85D3A, #5B8C6F, #2A9D8F); background-size: 200% 100%; animation: shimmer 4s linear infinite; }
...
.s10-item { display: flex; align-items: flex-start; gap: 12px; color: rgba(255,248,240,0.85); font-size: 0.95rem; line-height: 1.5; }
.s10-num { width: 26px; height: 26px; border-radius: 8px; background: rgba(42,157,143,0.15); color: var(--teal); font-family: var(--display); font-size: 0.8rem; display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
.s10-cta-wrap { text-align: center; }
.s10-cta {
  display: inline-block; background: linear-gradient(135deg, var(--coral), var(--gold)); color: #fff; font-family: var(--display);
  font-size: 1rem; padding: 14px 36px; border-radius: 12px; text-decoration: none; box-shadow: 0 4px 20px rgba(232,93,58,0.3);
  transition: transform 0.2s ease, box-shadow 0.2s ease;
}
.s10-cta:hover { transform: translateY(-2px); box-shadow: 0 8px 28px rgba(232,93,58,0.4); }
.s10-cta--secondary {
...
.s10-cta-sub { font-size: 0.78rem; color: rgba(255,248,240,0.4); margin-top: 8px; }
.s10-contact { text-align: center; font-size: 0.85rem; color: rgba(255,248,240,0.35); margin-top: 12px; }
...
<section class="slide slide--dark" id="cover" data-slide-index="0" data-theme="dark">
  ...
  <svg class="float-shape" style="top:15%;right:8%;width:80px;height:80px;animation:floatDrift 16s ease-in-out infinite 2s;" viewBox="0 0 80 80" fill="none"><polygon points="40,5 75,65 5,65" stroke="rgba(212,149,43,0.3)" stroke-width="1.5"/></svg>
  <svg class="float-shape" style="bottom:25%;left:5%;width:60px;height:60px;animation:floatDrift 13s ease-in-out infinite 4s;" viewBox="0 0 60 60" fill="none"><circle cx="30" cy="30" r="25" stroke="rgba(42,157,143,0.25)" stroke-width="1.5"/></svg>
  <div class="slide-inner">
    ...
    <div class="cover-logos" data-reveal="up" data-delay="100">
      ...
      <span class="partner-logotype">
        <svg class="partner-icon" viewBox="0 0 24 24" fill="none" stroke="rgba(212,149,43,0.8)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 8h1a4 4 0 0 1 0 8h-1"/><path d="M2 8h16v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V8z"/><line x1="6" y1="1" x2="6" y2="4"/><line x1="10" y1="1" x2="10" y2="4"/><line x1="14" y1="1" x2="14" y2="4"/></svg>
        Blue Collie Coffee
      </span>
    </div>
    <h1 class="cover-title">
      <span class="line-1" data-reveal="up" data-delay="200">Blue Collie</span>
      <span class="line-2" data-reveal="up" data-delay="300">Coffee</span>
    ...
    <p class="cover-subtitle">
      <span class="text-reveal-mask"><span class="text-reveal-inner">A mission-driven coffee shop employing people with disabilities &mdash; partnering with the Triangle&rsquo;s only publication dedicated to the disability community.</span></span>
    </p>
    <div class="cover-pillars" data-reveal="up" data-delay="900">
      <div class="cover-pillar"><div class="cover-pillar-icon cover-pillar-icon--coral"><svg viewBox="0 0 24 24" fill="none" stroke="var(--coral)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg></div><span class="cover-pillar-label cover-pillar-label--coral">Mission</span></div>
      <div class="cover-pillar"><div class="cover-pillar-icon cover-pillar-icon--teal"><svg viewBox="0 0 24 24" fill="none" stroke="var(--teal)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg></div><span class="cover-pillar-label cover-pillar-label--teal">Community</span></div>
      <div class="cover-pillar"><div class="cover-pillar-icon cover-pillar-icon--gold"><svg viewBox="0 0 24 24" fill="none" stroke="var(--gold)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg></div><span class="cover-pillar-label cover-pillar-label--gold">Growth</span></div>
    </div>
    <div class="cover-footer" data-reveal="fade" data-delay="1100">
      <span>Prepared for Blue Collie Coffee &nbsp;|&nbsp; April 2026</span>
      <span>Will Sigmon, Area Director</span>
    </div>
  </div>
  <div class="scroll-hint" data-reveal="fade" data-delay="1400"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="rgba(255,248,240,0.6)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg></div>
</section>
...
<section class="slide slide--cream" id="why" data-slide-index="1" data-theme="light">
  <div class="slide-inner">
    ...
    <h2 class="section-title" data-reveal="up" data-delay="100" style="text-align:center;margin-left:auto;margin-right:auto;">Your mission is our mission</h2>
    <p class="section-subtitle" data-reveal="up" data-delay="200" style="text-align:center;margin-left:auto;margin-right:auto;">Blue Collie Coffee already lives the values UY! champions. A partnership amplifies both.</p>
    <div class="s2-quote" data-reveal="scale" data-delay="300">"When a business <span class="s2-quote-em">hires people with disabilities</span>, it doesn&rsquo;t just change their employees&rsquo; lives &mdash; it changes the whole community&rsquo;s perception of what&rsquo;s possible."</div>
    ...
    <div class="s2-timeline" id="s2Timeline">
      <div class="s2-tl-item" data-reveal="up" data-delay="600">
        <div class="s2-tl-dot s2-tl-dot--coral"><svg viewBox="0 0 24 24" fill="none" stroke="var(--coral)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg></div>
        <div class="s2-tl-title">Perfect alignment</div>
        <div class="s2-tl-desc">You employ people with disabilities every day. UY! tells those stories. Together, you become the face of inclusive employment in the Triangle.</div>
      </div>
      <div class="s2-tl-item" data-reveal="up" data-delay="800">
        <div class="s2-tl-dot s2-tl-dot--teal"><svg viewBox="0 0 24 24" fill="none" stroke="var(--teal)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg></div>
        <div class="s2-tl-title">Built-in audience</div>
        <div class="s2-tl-desc">1 in 4 U.S. adults has a disability. Families, caregivers, and advocates in the Triangle are actively looking for businesses like yours.</div>
      </div>
      <div class="s2-tl-item" data-reveal="up" data-delay="1000">
        ...
        <div class="s2-tl-desc">Part of N2&rsquo;s national network &mdash; 800+ publications, $163M in reach, and 20+ years of proven infrastructure behind every issue.</div>
      </div>
    </div>
  </div>
</section>
...
<section class="slide slide--cream" id="what" data-slide-index="2" data-theme="light">
  <div class="slide-inner">
    ...
    <p class="section-subtitle" data-reveal="up" data-delay="200">Uniquely You! connects mission-driven businesses to the families and advocates who need them most.</p>
    <div class="s3-infographic">
      <div class="s3-viz" data-reveal="scale" data-delay="300">
        <div class="s3-viz-mark donut-wrap" id="donutWrap"><svg viewBox="0 0 160 160" aria-hidden="true"><circle cx="80" cy="80" r="65" fill="none" stroke="#e8ddd0" stroke-width="18"/><circle class="donut-ring" id="donutRing" cx="80" cy="80" r="65" fill="none" stroke="var(--coral)" stroke-width="18" stroke-linecap="round" stroke-dasharray="408" stroke-dashoffset="306" transform="rotate(-90 80 80)"/></svg><div class="donut-center-text" id="donutText" aria-label="1 in 4"><span class="donut-kicker">1 in</span><span class="donut-value">4</span></div></div>
      ...
      <div class="s3-viz" data-reveal="scale" data-delay="450">
        <div class="s3-viz-mark"><svg viewBox="0 0 160 160" aria-hidden="true"><circle cx="80" cy="80" r="65" fill="none" stroke="#d8f0ec" stroke-width="18"/><circle cx="80" cy="80" r="65" fill="none" stroke="var(--teal)" stroke-width="18" stroke-linecap="round" stroke-dasharray="408" stroke-dashoffset="0" transform="rotate(-90 80 80)"/></svg><div class="s3-icon-badge" aria-hidden="true"><svg width="66" height="66" viewBox="0 0 66 66" fill="none"><rect x="10" y="12" width="46" height="42" rx="11" fill="#fff" stroke="rgba(42,157,143,0.32)" stroke-width="2"/><rect x="10" y="12" width="46" height="12" rx="11" fill="rgba(42,157,143,0.16)"/><line x1="22" y1="8" x2="22" y2="19" stroke="var(--teal)" stroke-width="2.4" stroke-linecap="round"/><line x1="44" y1="8" x2="44" y2="19" stroke="var(--teal)" stroke-width="2.4" stroke-linecap="round"/><line x1="19" y1="30" x2="47" y2="30" stroke="rgba(42,157,143,0.25)" stroke-width="2" stroke-linecap="round"/><circle cx="24" cy="39" r="2.4" fill="var(--teal)" opacity="0.45"/><circle cx="33" cy="39" r="2.4" fill="var(--teal)" opacity="0.9"/><circle cx="42" cy="39" r="2.4" fill="var(--teal)" opacity="0.45"/><rect x="24" y="45" width="18" height="4" rx="2" fill="var(--teal)" opacity="0.22"/></svg></div></div>
      ...
      <div class="s3-viz" data-reveal="scale" data-delay="600">
        <div class="s3-viz-mark"><svg viewBox="0 0 160 160" aria-hidden="true"><circle cx="80" cy="80" r="65" fill="none" stroke="#e8ddd0" stroke-width="18"/><circle cx="80" cy="80" r="65" fill="none" stroke="var(--gold)" stroke-width="18" stroke-linecap="round" stroke-dasharray="408" stroke-dashoffset="0" transform="rotate(-90 80 80)"/></svg><div class="s3-hero-number" style="color:var(--gold);">5</div></div>
        <div class="s3-viz-label">Coverage</div>
        <div class="s3-viz-desc">Counties across RDU</div>
      </div>
    </div>
    <div class="s3-pillars">
      <div class="s3-pillar s3-pillar--coral" data-reveal="up" data-delay="700"><div class="s3-pillar-icon" style="background:rgba(232,93,58,0.1);"><svg viewBox="0 0 24 24" fill="none" stroke="var(--coral)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11.017 2.814a1 1 0 0 1 1.966 0l1.051 5.558a2 2 0 0 0 1.594 1.594l5.558 1.051a1 1 0 0 1 0 1.966l-5.558 1.051a2 2 0 0 0-1.594 1.594l-1.051 5.558a1 1 0 0 1-1.966 0l-1.051-5.558a2 2 0 0 0-1.594-1.594l-5.558-1.051a1 1 0 0 1 0-1.966l5.558-1.051a2 2 0 0 0 1.594-1.594z"/></svg></div><h3>Employer Spotlights</h3><p>Blue Collie Coffee&rsquo;s story &mdash; hiring people with disabilities and building a welcoming space &mdash; is exactly the kind of content our readers share, save, and act on.</p></div>
      <div class="s3-pillar s3-pillar--teal" data-reveal="up" data-delay="850"><div class="s3-pillar-icon" style="background:rgba(42,157,143,0.1);"><svg viewBox="0 0 24 24" fill="none" stroke="var(--teal)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polygon points="16.24 7.76 14.12 14.12 7.76 16.24 9.88 9.88 16.24 7.76"/></svg></div><h3>Resource Hub</h3><p>Local events, support groups, and community calendars &mdash; connecting families to places like yours that genuinely welcome everyone.</p></div>
      <div class="s3-pillar s3-pillar--gold" data-reveal="up" data-delay="1000"><div class="s3-pillar-icon" style="background:rgba(212,149,43,0.1);"><svg viewBox="0 0 24 24" fill="none" stroke="var(--gold)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/><line x1="12" y1="2" x2="12" y2="4"/></svg></div><h3>Advocacy &amp; Awareness</h3><p>Policy updates, accessibility news, and inclusive employer features &mdash; content that moves the needle on disability employment in the Triangle.</p></div>
    </div>
  </div>
</section>
...
<section class="slide slide--cream" id="synergy" data-slide-index="3" data-theme="light">
  ...
  <div class="slide-inner">
    ...
    <div class="s4-grid">
      <div class="s4-card s4-card--coral" data-reveal="up" data-delay="350"><div class="s4-card-icon" style="background:rgba(232,93,58,0.1);"><svg viewBox="0 0 24 24" fill="none" stroke="var(--coral)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 22h16a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v16a2 2 0 0 1-2 2Zm0 0a2 2 0 0 1-2-2v-9c0-1.1.9-2 2-2h2"/><path d="M18 14h-8"/><path d="M15 18h-5"/><path d="M10 6h8v4h-8V6Z"/></svg></div><h3>Print + Digital Every Month</h3><p>Your ad in a high-quality magazine mailed directly to homes &mdash; plus a digital companion with clickable links. We handle all the design.</p></div>
      <div class="s4-card s4-card--teal" data-reveal="up" data-delay="450"><div class="s4-card-icon" style="background:rgba(42,157,143,0.1);"><svg viewBox="0 0 24 24" fill="none" stroke="var(--teal)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg></div><h3>Your Ideal Customer Reads UY!</h3><p>Families navigating disability, caregivers, educators, therapists &mdash; the exact people who seek out an inclusive, mission-driven coffee shop like yours.</p></div>
      <div class="s4-card s4-card--gold" data-reveal="up" data-delay="550"><div class="s4-card-icon" style="background:rgba(212,149,43,0.1);"><svg viewBox="0 0 24 24" fill="none" stroke="var(--gold)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2L14.5 9.5L22 12L14.5 14.5L12 22L9.5 14.5L2 12L9.5 9.5L12 2Z"/></svg></div><h3>Feature Story Opportunities</h3><p>Your mission, your team, your why &mdash; shared as a spotlight article with thousands of readers who value purpose-driven businesses in their community.</p></div>
      <div class="s4-card s4-card--brown" data-reveal="up" data-delay="650"><div class="s4-card-icon" style="background:rgba(139,94,60,0.1);"><svg viewBox="0 0 24 24" fill="none" stroke="var(--brown-sec)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polygon points="16.24 7.76 14.12 14.12 7.76 16.24 9.88 9.88 16.24 7.76"/></svg></div><h3>Community Directory</h3><p>Every partner is listed in our online resource directory at uyrdu.com &mdash; a permanent, searchable presence connecting you to families actively seeking inclusive businesses.</p></div>
    </div>
  </div>
</section>
...
<section class="slide slide--cream" id="partnership" data-slide-index="4" data-theme="light">
  <div class="slide-inner">
    ...
    <p class="section-subtitle" data-reveal="up" data-delay="200">Visibility, credibility, and a direct line to the community you already serve.</p>
    <div class="s7-staircase">
      <div class="s7-step s7-step--1" data-reveal="up" data-delay="400"><div class="s7-level-label">Visibility</div><div class="s7-step-icon" style="background:rgba(232,93,58,0.1);"><svg viewBox="0 0 24 24" fill="none" stroke="var(--coral)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 22h16a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v16a2 2 0 0 1-2 2Zm0 0a2 2 0 0 1-2-2v-9c0-1.1.9-2 2-2h2"/><path d="M18 14h-8"/><path d="M15 18h-5"/><path d="M10 6h8v4h-8V6Z"/></svg></div><h3>Be Present</h3><p>A beautifully designed ad in every issue &mdash; we handle the creative. Blue Collie Coffee in front of families every month.</p><ul class="s7-step-items"><li>Print ad &mdash; we design it for you</li><li>Digital companion with clickable link</li><li>Logo in partner directory</li></ul></div>
      <div class="s7-step s7-step--2" data-reveal="up" data-delay="600"><div class="s7-level-label">Authority</div><div class="s7-step-icon" style="background:rgba(42,157,143,0.1);"><svg viewBox="0 0 24 24" fill="none" stroke="var(--teal)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg></div><h3>Be Useful</h3><p>Share your expertise on inclusive employment, coffee culture, or community building. We help you create content that positions you as the go-to.</p><ul class="s7-step-items"><li>Sponsored expert column</li><li>Inclusive hiring tips and spotlights</li><li>Workshop or event highlights</li></ul></div>
      <div class="s7-step s7-step--3" data-reveal="up" data-delay="800"><div class="s7-level-label">Legacy</div><div class="s7-step-icon" style="background:rgba(212,149,43,0.1);"><svg viewBox="0 0 24 24" fill="none" stroke="var(--gold)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3q1 4 4 6.5t3 5.5a1 1 0 0 1-14 0 5 5 0 0 1 1-3 1 1 0 0 0 5 0c0-2-1.5-3-1.5-5q0-2 2.5-4"/></svg></div><h3>Be Remembered</h3><p>Feature stories that share your mission, your team members&rsquo; journeys, and the impact you&rsquo;re making &mdash; content people keep and pass along.</p><ul class="s7-step-items"><li>Two feature profiles per year</li><li>Social media amplification</li><li>Community event co-branding</li></ul></div>
    </div>
  </div>
</section>
...
<section class="slide slide--dark" id="start" data-slide-index="6" data-theme="dark">
  ...
  <div class="slide-inner" style="display:flex;flex-direction:column;justify-content:center;">
    <div class="section-eyebrow" data-reveal="up" data-delay="50" style="color:rgba(255,248,240,0.58);">Next steps</div>
    <h2 class="s8-title" data-reveal="up" data-delay="100" style="margin-bottom:8px;">Let's make it happen</h2>
    <p class="section-subtitle" data-reveal="up" data-delay="180" style="color:rgba(255,248,240,0.74);max-width:840px;margin-bottom:20px;">Here's what the path forward looks like &mdash; whether we kick things off now or take a beat to think it over.</p>
    ...
    <div class="s10-cta-wrap" data-reveal="scale" data-delay="380" style="margin-top:20px;">
      ...
      <a class="s10-cta" href="https://portal.n2pub.com/agreement_builders" target="_blank" rel="noopener" style="background:linear-gradient(135deg, var(--teal), var(--sage));box-shadow:0 8px 30px rgba(42,157,143,0.3);">Build Agreement</a>
