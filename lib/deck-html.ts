...
const DECK_MODULES: Record<string, () => Promise<{ default: DeckData }>> = {
  ...
  landy: () => import("@/data/decks/landy"),
  made4me: () => import("@/data/decks/made4me"),
  mercalis: () => import("@/data/decks/mercalis"),
  ...
  bluecollie: () => import("@/data/decks/bluecollie"),
  chathamtrades: () => import("@/data/decks/chathamtrades"),
  ...
  "becoming-rentable": () => import("@/data/decks/becomingrentable"),
  becomingrentable: () => import("@/data/decks/becomingrentable"),
  "lorraine-woodward": () => import("@/data/decks/becomingrentable"),
  ...
  "integrity-ink": () => import("@/data/decks/integrityink"),
  integrityink: () => import("@/data/decks/integrityink"),
  "integrity-ink-notary": () => import("@/data/decks/integrityink"),
  "jessica-booker": () => import("@/data/decks/integrityink"),
